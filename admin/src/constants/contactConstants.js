...
export const CONTACT_UPDATE_STATUS_REQUEST = 'CONTACT_UPDATE_STATUS_REQUEST';
export const CONTACT_UPDATE_STATUS_SUCCESS = 'CONTACT_UPDATE_STATUS_SUCCESS';
export const CONTACT_UPDATE_STATUS_FAIL = 'CONTACT_UPDATE_STATUS_FAIL';
export const CONTACT_UPDATE_STATUS_RESET = 'CONTACT_UPDATE_STATUS_RESET';
