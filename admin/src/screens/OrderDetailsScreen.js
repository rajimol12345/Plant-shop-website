...
import { getOrderDetails, deliverOrder, payOrderManual } from '../actions/orderActions';
...
const OrderDetailsScreen = () => {
  ...
  }, [dispatch, orderId, successDeliver, successPay, order, userInfo, navigate]);
                ...
                !order.isPaid && (
                  <ListGroup.Item>
                    <Button
                      ...
                      style={{ backgroundColor: '#F8B864', color: '#000', border: 'none' }}
